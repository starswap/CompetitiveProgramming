#use the precalculated n Queens possibilities from 750
...
def printJust(ans,size,end='\n'):
  for i in range(size-len(ans)):
    print(" ",end="")
  print(ans,end=end)
...
for k in range(K):
  ...
  for ans in answers:
    score = 0
    for col, row in enumerate(ans[1:]):
      score += board[row-1][col-1]
